...
<head>
  ...
  <link rel="stylesheet" href="/css/spot-details.css">
...
<body>
 ...
 -->
  ...
  <div class="dt-top">
    ...
    <div class="top-left">
      <div class="link">
        <a href="/spot-trade">Spot trading <i class="fa fa-angle-right"></i></a>
        <p class="username"></p>
      </div>
  ...
  <div class="options">
    <p class="title tab active" id="tab1">Spot Trades</p>
  </div>
